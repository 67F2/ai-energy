  ...
  models: [
    {
      ...
      name: 'GPT-4o',
      provider: 'OpenAI',
      size: '~1.8T params (MoE, ~28B active)',
      gpuPowerW: 700,
      jPerInTok: 0.08,
      jPerOutTok: 1.5,
      priceInUsdPer1M: 2.50,
    ...
    },
    {
      ...
      jPerInTok: 0.03,
      jPerOutTok: 0.6,
      priceInUsdPer1M: 0.15,
      priceOutUsdPer1M: 0.60,
      waterPerQueryMl: 1.5,
      energyNote: 'decode-energy assumption (mid-range of 2026 published measurements)',
    ...
    },
    {
      ...
      provider: 'Anthropic',
      size: 'frontier dense/hybrid',
      gpuPowerW: 700,
      jPerInTok: 0.10,
      jPerOutTok: 1.3,
      priceInUsdPer1M: 3.00,
