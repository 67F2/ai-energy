...
const DATA = {
  ...
  rightToolForTask: [
    ...
    { task: 'A one-off summarisation of short text', best: 'Your AI app default', cost: 2, why: 'You usually do not pick the model yourself - the default or "quick" tier in most AI apps already routes simple requests to a smaller, cheaper model that uses far less energy than a flagship.' },
    ...
    { task: 'Images, audio, video generation', best: 'Use a real camera / mic / phone (no AI)', cost: 0, why: 'Recording with a phone or microphone uses no AI compute — near-zero resource use. AI generation of images, audio or video is far more energy-hungry than text, so generate only what you cannot record.' },
  ],
