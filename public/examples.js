const EXAMPLES = [
  ...
  },
  {
    ...
    fixedCostUsd: 0.04,
    fixedBaselineMl: 0,
    note: '~2.9 Wh per image (mean, Power Hungry Processing). Worst case ~11.5 Wh ~ half a smartphone charge per image. Cost = GPT Image 1 medium tier (~$0.042 per 1024x1024).',
    sources: ['powerHungry', 'gptImagePrice'],
  },
  {
    group: 'Vision & media',
    ...
    fixedCostUsd: 1.00,
    fixedBaselineMl: 0,
    note: '~90 Wh per short clip (WAN2.1-T2V-1.3B, 720x1280, 81 frames, 50 steps). ~30x more than image generation; a flagship 14B model is ~415 Wh. Cost = mid-range estimate of ~5-8 s clip from 2026 API per-second rates ($0.03-$0.70/s).',
    sources: ['videoEnergy', 'videoPrice'],
  },
  {
    group: 'Audio',
